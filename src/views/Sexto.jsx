...
const Sexto = () => {
  const semestre6 = [
    {
      semestre:"Profesiograma de 6to. Semestre",
      ...
      materiaE6:"Orientación Educativa VI",
      extendido5:"**Extendido",
      extendido6:"**Extendido",
      extendido7:"**Extendido",
      extendido8:"**Extendido",
      laboral7:"Laboral Básico",
      laboral8:"Laboral Básico",
      curriculum6:" - Curriculum Ampliado",
        ...
        <div className="p-4  dark:border-gray-700 mt-14  overflow-x-auto">
            <div>
              {
                semestre6.map ((semestre6 =>{
                  return (
                    <>                
                      <h2 className='text-xl m-8 dark:text-white' key={semestre6}>{semestre6.semestre}</h2>
                      <Table>
                        <Table.Head>
                        ...
                        <Table.Body className="divide-y">
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Materias33' outline color="gray">{semestre6.materia33}</Button>                              
                            </Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Materias34' outline color="gray">{semestre6.materia34}</Button>
                            </Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Materias35' outline color="gray">{semestre6.materia35}</Button>
                            </Table.Cell>
                            <Table.Cell>4</Table.Cell>
                            <Table.Cell>1</Table.Cell>
                            <Table.Cell>5</Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/MateriasE6' outline color="gray">{semestre6.materiaE6}</Button>
                            </Table.Cell>
                            <Table.Cell>3</Table.Cell>
                            <Table.Cell>0.75</Table.Cell>
                            <Table.Cell>3.75</Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Extendido5' outline color="gray">{semestre6.extendido5}</Button>
                            </Table.Cell>
                            <Table.Cell>3</Table.Cell>
                            <Table.Cell>0.75</Table.Cell>
                            <Table.Cell>3.75</Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Extendido6' outline color="gray">{semestre6.extendido6}</Button>
                            </Table.Cell>
                            <Table.Cell>3</Table.Cell>
                            <Table.Cell>0.75</Table.Cell>
                            <Table.Cell>3.75</Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Extendido7' outline color="gray">{semestre6.extendido7}</Button>
                            </Table.Cell>
                            <Table.Cell>3</Table.Cell>
                            <Table.Cell>0.75</Table.Cell>
                            <Table.Cell>3.75</Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Extendido8' outline color="gray">{semestre6.extendido8}</Button>
                            </Table.Cell>
                            <Table.Cell>3</Table.Cell>
                            <Table.Cell>0.75</Table.Cell>
                            <Table.Cell>3.75</Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Laboral7' outline color="gray">{semestre6.laboral7}</Button>
                            </Table.Cell>
                            <Table.Cell>3</Table.Cell>
                            <Table.Cell>0.75</Table.Cell>
                            <Table.Cell>3.75</Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Laboral8' outline color="gray">{semestre6.laboral8}</Button>
                            </Table.Cell>
                            <Table.Cell>4</Table.Cell>
                            <Table.Cell>1</Table.Cell>
                            <Table.Cell>5</Table.Cell>
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/Curriculum6' outline color="gray">{semestre6.curriculum6}</Button>
                            </Table.Cell>
                            <Table.Cell>3</Table.Cell>
                            <Table.Cell>0.75</Table.Cell>
                            <Table.Cell>3.75</Table.Cell>
            ...
            <div className="mb-11 mt-11">
              ...
              <Accordion collapseAll>
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>* Temas Selectos de Matemáticas II</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    

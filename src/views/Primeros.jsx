        ...
        <div className="p-4  dark:border-gray-700 mt-14  overflow-x-auto">
            <div>
              {
                semestre1.map ((semestre1 =>{
                  return (
                    <>                
                      <h2 className='text-xl m-8 dark:text-white' key={semestre1}>{semestre1.semestre}</h2>
                      <Table>
                        <Table.Head>
            ...
            <div className="mb-11 mt-11">
              ...
              <Accordion collapseAll>
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Ciencias Sociales I</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Cultura Digital I</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Pensamiento Matematico I</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Lengua y Comunicación I</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Ingles I</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Humanidades I</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    

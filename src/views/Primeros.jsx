...
const Primeros = () => {
  const semestre1 = [
    {
      semestre:"Profesiograma de 1er. Semestre",
      ...
      materiaE9:"Orientación Educativa I",
        ...
        <div className="p-4  dark:border-gray-700 mt-14  overflow-x-auto">
                    ...
                    <>                
                      ...
                      <Table>
                        ...
                        <Table.Body className="divide-y">
                          ...
                          <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                            <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                              <Button href='/MateriasE9' outline color="gray">{semestre1.materiaE9}</Button>
                            </Table.Cell>
                            <Table.Cell>3</Table.Cell>
                            <Table.Cell>0.75</Table.Cell>
                            <Table.Cell>3.75</Table.Cell>
            ...
            <div className="mb-11 mt-11">
              ...
              <Accordion collapseAll>
                  ...
                  <Accordion.Panel>
                    <Perfiles 
                      titulo={"Pensamiento Matematico I"}
                  ...
                  <Accordion.Panel>
                    <Perfiles 
                      titulo={"Lengua y Comunicación I"}
                  ...
                  <Accordion.Panel>
                    <Perfiles 
                      titulo={"Orientación Educativa I"}

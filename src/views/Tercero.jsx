        ...
        <div className="p-4  dark:border-gray-700 mt-14  overflow-x-auto">
            ...
            <div className="mb-11 mt-11">
              ...
              <Accordion collapseAll>
                  <Accordion.Panel>
                    <Accordion.Title>Ecosistemas, Interacciones, Energía y Dinámica</Accordion.Title>
                      <Accordion.Content >
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Pensamiento Matematico III</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Lengua y Comunicación III</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Ingles III</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>Humanidades III</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
                  ...
                  <Accordion.Panel>
                    <Accordion.Title>* Taller de Ciencias II</Accordion.Title>
                      <Accordion.Content >
                        <p className="mb-2 text-gray-500 font-bold dark:text-gray-400">
                          Licenciatura
                        </p>    
